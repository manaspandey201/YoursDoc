  ...
  render() {
    return (
      <div>
        ...
        <p class="t-phar">
          YoursDoc has revolutionized the Indian healthcare industry. For
          ...
          healthcare experiences. At YoursDoc, we provide both clinical and
          ...
          of beautifully landscaped garden.Our hospital provides state of
